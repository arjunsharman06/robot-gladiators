var fight = function (enemy) {
    ...
    while (playerInfo.health> 0 && enemy.health > 0) {
        ...
        // remove enemy's health by subtracting the amount set in the playerInfo.attackvariable
        ...
        // remove players's health by subtracting the amount set in the enemy.attackvariable
        var damage = randomNumber(enemy.attack- 3, enemyAttack);
